...
// Toggle stars
function toggleStars(buttonText, button, redTeamStarContainerEl, blueTeamStarContainerEl) {
...
function updateStarCount(side, action, redTeamStarContainerEl, blueTeamStarContainerEl, redTeamName, blueTeamName) {
    // Update star count
...
function setDefaultStarCount(bestOf, redTeamStarContainerEl, blueTeamStarContainerEl) {
    redStarCount = 0
    blueStarCount = 0
    totalBestOf = bestOf
...
// Display Stars
function toggleStarContainers(redTeamStarContainerEl, blueTeamStarContainerEl) {
...
function renderStars(redTeamStarContainerEl, blueTeamStarContainerEl) {
